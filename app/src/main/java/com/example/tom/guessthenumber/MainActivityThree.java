        ...
        b_flip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(coinSide == 0) {
                    ...
                    Toast.makeText(MainActivityThree.this, "Heads", Toast.LENGTH_SHORT).show();
                } else if  (coinSide == 1) {
                    iv_coin.setImageResource(R.drawable.tails);
                    Toast.makeText(MainActivityThree.this, "Tails", Toast.LENGTH_SHORT).show();
                }
